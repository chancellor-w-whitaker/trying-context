...
// prevent scrollbar page layout shift (write to index.css)
// how to handle filters & lists being remembered (write to useProvideGlobally in AppContextProvider.jsx) (should you change state structure of checklist?)
