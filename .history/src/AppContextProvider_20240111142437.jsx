...
const onBeforeEndFunc = (setFieldFilters) => (data, setResult) => {
  const fieldToColumn = {};
  ...
  setFieldFilters((thisState) =>
    !thisState ? initialFieldFilters : thisState
  );
...
const useProvideGlobally = () => {
  ...
  const onBeforeEnd = useCallback(onBeforeEndFunc(setFieldFilters), []);
